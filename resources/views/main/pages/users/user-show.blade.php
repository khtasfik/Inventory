...
<!-- /Notification Ends -->
			...
			<h4 class="col-auto text-primary">User Add Here</h4>
			<div class="form-row">
			...
			@csrf
				...
				<div class="col-auto">
					<label class="sr-only" for="inlineFormInputGroup">User Email</label>
					<div class="input-group mb-2">
					<div class="input-group-prepend">
				...
				<div class="col-auto">
					<label class="sr-only" for="inlineFormInputGroup">User Password</label>
					<div class="input-group mb-2">
					<div class="input-group-prepend">
				...
				<div class="col-auto">
					<label class="sr-only" for="inlineFormInputGroup">User Contact Number</label>
					<div class="input-group mb-2">
					<div class="input-group-prepend">
				...
				<div class="col-auto">
					<label class="sr-only" for="inlineFormInputGroup">User Image</label>
					<div class="input-group mb-2">
					<div class="input-group-prepend">
				...
				<div class="col-auto">
					<label class="sr-only" for="inlineFormInputGroup">User Type</label>
					<div class="input-group mb-2">
					<div class="input-group-prepend">
