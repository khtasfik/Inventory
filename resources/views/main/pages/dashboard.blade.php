                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xl-6">
                            <div class="card">
                                <div class="card-body text-center statistics-info">
                                    ...
                                    <p class="text-muted">Sed ut perspiciatis unde omnis accusantium doloremque
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-4">
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="mb-0">
                                <p class="mb-2">Internet Explore<span class="float-right text-muted">50%</span>
                                </p>
                                <div class="progress h-2">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-4">
                    <div class="card">
                        ...
                        <div class="p-4 border-bottom">
                            <p class="mb-2 text-muted">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                sed do eiusmod.</p>
                            <div class="row">
                                <div class="col">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row d-flex align-items-center mt-3">
                                <div class="col">
                                    ...
                                    <h2 class="d-flex mb-0 number-font">$35487<small><i
                                                class="fe fe-arrow-up text-success"></i></small></h2>
                                </div>
                        ...
                        <div class="card-body pb-0">
                            <div class="">
                                <div class="d-flex">
                                    ...
                                    <div class="ml-auto">
                                        <a class="btn btn-light btn-sm btn-icon mr-2" href="#"><i
                                                class="fa fa-chevron-left"></i></a>
                                        <a class="btn btn-light btn-sm btn-icon" href="#"><i
                                ...
                                <p class="mb-0 mt-2 text-muted">Lorem ipsum dolor sit amet odio consectetur
                                    accusamus .</p>
                            </div>
                        </div>
                        <div class="chart-wrapper">
                    ...
                    <div class="card overflow-hidden">
                        <div class="card-body pb-0">
                            <div class="">
                                ...
                                <span class="text-success"><i
                                        class="zmdi zmdi-long-arrow-up zmdi-hc-lg mr-2"></i><span>90.5%</span></span><span
                                    class="text-muted ml-2">From Last Month</span>
                                <p class="mb-0 mt-2 text-muted">Lorem ipsum dolor sit amet odio consectetur
                                    accusamus .</p>
                            </div>
                    ...
                    <div class="card overflow-hidden">
                        <div class="card-body pb-0">
                            <div class="">
                                ...
                                <span class="text-success"><i
                                        class="zmdi zmdi-long-arrow-up zmdi-hc-lg mr-2"></i><span>20.8%</span></span><span
                                    class="text-muted ml-2">From Last Month</span>
                                <p class="mb-0 mt-2 text-muted">Lorem ipsum dolor sit amet odio consectetur
                                    accusamus .</p>
                            </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table card-table border table-vcenter text-nowrap align-items-center">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="text-sm font-weight-600">Mens Gold Metal Watch
                                                    </td>
                                                    <td>11</td>
                                                    <td>04</td>
                                                    <td>0</td>
